...
local function animation(position, width, color)
    return {
        { time = 0,   x = geometry.lane_left_margin + position, y = geometry.judge_line_y, w = width, h = geometry.note_height, r = color.r, g = color.g, b = color.b, a = 255 },
        { time = 250, x = geometry.lane_left_margin + position, y = geometry.judge_line_y, w = width, h = geometry.note_height, r = color.r, g = color.g, b = color.b, a = 128 },
        { time = 500, x = geometry.lane_left_margin + position, y = geometry.judge_line_y, w = width, h = geometry.note_height, r = color.r, g = color.g, b = color.b, a = 0 },
    }
end
